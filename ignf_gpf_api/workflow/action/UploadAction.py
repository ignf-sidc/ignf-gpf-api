...
class UploadAction:
    ...
    def __init__(self, dataset: Dataset, behavior: Optional[str] = None) -> None:
        ...
        self.__behavior: str = behavior if behavior is not None else str(Config().get("upload", "behavior_if_exists"))
    ...
    def monitor_until_end(upload: Upload, callback: Optional[Callable[[str], None]] = None) -> bool:
        ...
        s_check_message_pattern = str(Config().get("upload", "check_message_pattern"))
