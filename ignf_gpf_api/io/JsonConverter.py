...
class JsonConverter(metaclass=Singleton):
    ...
    def __init__(self) -> None:
        ...
        self.__datetime_pattern = str(Config().get("json_converter", "datetime_pattern"))
        self.__date_pattern = str(Config().get("json_converter", "date_pattern"))
        self.__time_pattern = str(Config().get("json_converter", "time_pattern"))
